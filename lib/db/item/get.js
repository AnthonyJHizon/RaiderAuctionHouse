...
export async function getRelevantItems() {
	const gemItemLevel = 85;
	const consuamblesItemLevel = 85;
	const tradeGoodsItemLevel = 81;

	try {
		const results = await Promise.all([
			getItemsByClass('Gem', gemItemLevel),
			getItemsByClass('Consumable', consuamblesItemLevel),
			getItemsByClass('Trade Goods', tradeGoodsItemLevel),
