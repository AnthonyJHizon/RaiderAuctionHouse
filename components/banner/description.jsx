...
export default function Description() {
	return (
		<div className="flex flex-col justify-between w-full h-full font-bold text-wrap text-secondary z-10 [text-shadow:_1px_1px_5px_rgb(0_0_0/_80%)] md:pt-[5%] pt-[20%] pl-[7%] pr-[7%] md:pb-[2%] pb-[10%]">
			<div className="w-full text-title-1 text-center">
				<p className="text-white">Filtered auction house data for </p>
				<p>Cataclysm Classic</p>
			</div>
